      ...
      <div className="max-w-md w-full mx-auto px-6 py-16">
        <div data-aos="fade-up">
          ...
          <p className="font-body text-sm font-light text-ink-muted mb-10 leading-relaxed">
            Start automating tailored applications in minutes.
          </p>

          <form onSubmit={onSubmit} className="space-y-5">
            <div>
              <label htmlFor="name" className="block font-body text-xs tracking-caps uppercase text-ink-muted mb-2">
          ...
          <p className="mt-8 font-body text-sm text-ink-muted">
            ...
            <Link to="/login" className="text-ink underline underline-offset-4 hover:text-secondary transition-colors">
              Sign in
            </Link>
          </p>
        </div>
